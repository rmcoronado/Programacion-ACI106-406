Basado en tu archivo **clase_1.md** , armé una **versión pedagógica mejorada** (sin redundancias, con índice linkeado, diagramas/recursos visuales y ejercicios evaluativos).

**Descarga aquí:** [clase_1_mejorada.md](sandbox:/mnt/data/clase_1_mejorada.md)

A continuación te dejo el contenido completo del `.md` mejorado:
